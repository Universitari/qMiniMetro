...
const int ST_1[2] = { STATION_SIZE*2 + STATION_GRID*3*5, 2*STATION_SIZE + 5 + STATION_GRID*3*3 };
const int ST_2[2] = { STATION_SIZE*2 + STATION_GRID*3*7, 2*STATION_SIZE + 5 + STATION_GRID*3*3 };
const int ST_3[2] = { STATION_SIZE*2 + STATION_GRID*3*7, 2*STATION_SIZE + 5 + STATION_GRID*3*5 };